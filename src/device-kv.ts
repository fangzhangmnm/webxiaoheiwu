...
//   住这里的：imeEnabled（默认开；"0"=改用系统输入法）、softKeyboard（none|ascii，跟设备走）、fontScale（字号档位，跟屏幕走）、voiceModelSource、lang、lastOpenName（本机续写指针）。voiceEnabled 已退役（语音默认开，2026-09-03）。
