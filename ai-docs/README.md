# ai-docs — WebXiaoHeiWu

> as-of v0.0.82 / 2026-09-03。信任顺序：代码 > journals 人类原话 > ADR > 本目录 how-doc（每篇顶部有 as-of 戳，戳后的话优先于正文）。

起手：[20260903-v2-architecture.md](20260903-v2-architecture.md)（模块地图 / 数据类→store 映射 / v1→v2 对照 / 待拍板）。

ADR（决策与否决，防 re-litigate）：
