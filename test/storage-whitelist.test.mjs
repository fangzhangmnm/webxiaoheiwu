...
const ALLOW = {
  "src/device-kv.ts": "localStorage：device 层标量唯一器官（imeEnabled / softKeyboard / fontScale / voiceModelSource / lang / lastOpen / gallery-folder / last-scene / diag-log 黑匣子环；voiceEnabled 为死键）",
